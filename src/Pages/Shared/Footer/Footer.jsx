      ...
      <div className=" bg-[#001E00] rounded-xl px-14 py-8">
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          <div className="md:max-w-md lg:col-span-2">
            <h3 className="text-[#A737D5] text-3xl font-bold font-mono">
              Bright Future
            </h3>
          ...
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            <div>
              <p className="font-semibold tracking-wide text-[#A737D5]">
                Category
              </p>
              <ul className="mt-2 space-y-2">
                <li>
                  <a
                    href="/"
                    className="transition-colors duration-300 text-purple-50 hover:text-[#A737D5]"
                  >
                    News
                  </a>
                </li>
