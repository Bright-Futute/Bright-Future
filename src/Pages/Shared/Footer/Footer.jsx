      ...
      <div className=" bg-[#001E00] rounded-xl px-14 py-8">
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          <div className="md:max-w-md lg:col-span-2">
            <h3 className="text-[#fe9105] text-3xl font-bold font-mono">
              Bright Future
            </h3>
          ...
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            <div>
              <p className="font-semibold tracking-wide text-[#fe9105]">
                Category
              </p>
              <ul className="mt-2 space-y-2">
                <li>
                  <a
                    href="/"
                    className="transition-colors duration-300 text-purple-50 hover:text-[#fe9105]"
                  >
                    News
                  </a>
                </li>
        ...
        <div className="flex flex-col justify-between pt-5 border-t border-purple-200 sm:flex-row">
          ...
          <div className="flex items-center mt-4 space-x-4 sm:mt-0">
            <a
              href="/"
              className="transition-colors duration-300 text-purple-100 hover:text-[#fe9105]"
            >
