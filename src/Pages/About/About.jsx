...
const About = () => {
  return (
      ...
      >
        <h2 className="text-center font-mono text-[20px] lg:text-4xl font-[700] mb-10">
          About
        ...
        <div className="flex flex-col lg:flex-row gap-y-10 lg:gap-x-5 justify-between items-center">
          ...
          <div className=" lg:w-2/4">
            ...
            <p>
              ...
              Fugiat atque eveniet a, distinctio vel, quas repellendus ab
              ratione beatae porro libero, odio modi neque unde debitis
              laudantium ullam. Veniam id numquam labore obcaecati consectetur
              molestiae beatae tempora eligendi voluptates accusamus.
            </p>
          </div>
        </div>
      </section>
