            ...
            <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
              <div>
                <p className="text-justify">
                  Bright Future is a startup software company that specializes
                  in creating web apps, Android apps, and UI/UX designs. We were
              ...
              <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                <div>
                  <p className="text-justify">
                    ...
                    solutions and services. We offer a range of services
                    including web-based application development, software and
                    Android app development, and internet marketing strategy
                    development. We also specialize in web application design,
                    helping our clients to create beautiful, functional, and
                    user-friendly interfaces for their customers. Our team of
                    experienced developers and designers is committed to
                    creating innovative solutions that meet the needs of our
                    customers. We are dedicated to maintaining long-term
                    relationships with our clients and providing them with the
                    support they need to succeed in today's digital era.
                  </p>
                </div>
